...
public class RegistFail2 extends JPanel {
	
	private MainFrame mf;
	private JPanel RegistFail2;

	
	public RegistFail2(MainFrame mf) {
		
		/*현재 프레임 및 클래스 set*/
		this.mf = mf;
		this.RegistFail2 = this;
	...
	b1.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			changePanel(mf, RegistFail2, new LogIn1(mf));
		}
	});
	...
	b2.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			if(idtext.getText().equals("")) {
				changePanel(mf, RegistFail2, new RegistFail1(mf));
			} else if(pwdtext.getText().equals("")) {
				changePanel(mf, RegistFail2, new RegistFail2(mf)); 
			} else if(nametext.getText().equals("")) {
				changePanel(mf, RegistFail2, new RegistFail3(mf));
			} else {
				changePanel(mf, RegistFail2, new RegistCheck(mf));
		}
		}
	});
