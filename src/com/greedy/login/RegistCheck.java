...
public class RegistCheck extends JPanel{
	...
	private JPanel RegistCheck;

	
	public RegistCheck(MainFrame mf) {

		/*현재 프레임 및 클래스 set*/
		this.mf = mf;
		this.RegistCheck = this;
	...
	/* 회원가입 확인 창 */
	JLabel registCheck = new JLabel(new ImageIcon("images/ui/login-registCheck.PNG"));
	...
	/* 패널에 컴포넌트 추가 */
	this.add(b1);
	this.add(registCheck);	//회원가입 화인 창
